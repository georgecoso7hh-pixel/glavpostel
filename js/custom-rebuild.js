...
var REVIEWS=[
 ...
 {art:37,name:"Светлана",city:"Воронеж",date:"19 января 2025",rating:4,
  pros:"Сатин действительно качественный, бельё плотное.",cons:"Ткань гладкая, сатин точно. Рисунок полностью соответствует фото, ткань плотная. После стирки ничего не полиняло, рисунок целый. Всё отлично, долго искала бельё такого качества — рекомендую!",
 ...
 {art:27,name:"Ирина",city:"Казань",date:"21 декабря 2024",rating:5,
  pros:"Хорошее постельное бельё, в очередной раз радует. На 100% соответствует описанию. При стирке не село, расцветка огонь — нежная, красивая, уютная. Со скидкой можно и ещё взять)) Рекомендую.",cons:"",
 ...
 {art:23,name:"Татьяна",city:"Сочи",date:"3 марта 2025",rating:5,
  ...
  comment:"Это уже второй комплект у меня, и он идеален! Ткань, расцветка, пошив — я в полном восторге. После стирки легко гладится. Спасибо!",
 ...
 {art:20,name:"Юлия",city:"Нижний Новгород",date:"16 февраля 2025",rating:5,
  ...
  comment:"Очень качественное бельё, материал плотный и будто шелковистый, при этом совсем не похож на синтетику и приятно холодит. Уже постирала разок — катышков нет, цвет пастельный, приятный. Рекомендую!",
 ...
 {art:13,name:"Виктория",city:"Пермь",date:"24 декабря 2024",rating:5,
  pros:"Супер бельё! Красивый набор, ткань нежная и приятная. Уже простирала — все краски как были, так и остались, по размеру всё точно совпало. Спасибо!",cons:"",
 ...
 {art:5,name:"Оксана",city:"Саратов",date:"30 января 2025",rating:5,
  ...
  comment:"Беру уже второй комплект в этой расцветке. В этот раз коробка пришла целой, всё сложено аккуратно. Комплект замечательный — для тех, кто любит классику и спокойные оттенки. Хлопок, сатиновое плетение, лёгкий эффект шелковистости, в меру плотный, но мягкий.",
